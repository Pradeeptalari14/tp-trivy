# 🛡️ Trivy Security Studio
> Configure supply chain vulnerability scans. Generate CLI execution strings, trivy.yaml config files, CI actions, whitelist ignores, and simulate CVE reports in real-time.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/trivy/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/trivy/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-trivy.git
cd tp-trivy
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/trivy/) |
